---
title: "Part_2_Air_Temperature_Data"
...
If you are using the data downloaded directly from Canvas, use the commented out code for Option 2 in the second half of this code chunk.
...
```{r}
###Option 2 ONLY 
##If choosing to use example dataset downloaded from Canvas. Make sure the downloaded files are in your working directory
...
Now we have the temperature data matching our Phenology data from the previous tutorial, we want to save it to our computer to use in future analyses (or the next tutorial). This is optional if you are continuing straight to part 3 as you already have this data in R. If you're going to wait and come back to complete part 3, go ahead and save the file you've created here. 
...
And now we're ready to put it all together in part 3. 
