## ----set-up--------------------------------------------------------------------------------------------
# install needed package (only uncomment & run if not already installed). You can uncomment this by simply removing the 
#hashtags. You can run it by highlighting it and hitting the "Run"button or by hitting command return (among other ways)
...
#Option 1: You can dowload the data directly from the NEON site.
